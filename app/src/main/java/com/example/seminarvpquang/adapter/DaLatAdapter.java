...
public class DaLatAdapter extends BaseAdapter {
    int x = 0;
    private DaLatActivity context;
    private int layout;
    private List<Place> arraListPlace;

    public DaLatAdapter(DaLatActivity context, int layout, List<Place> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        DaLatAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new DaLatAdapter.ViewHolder();
            ...
            viewHolder = (DaLatAdapter.ViewHolder) view.getTag();
        }
