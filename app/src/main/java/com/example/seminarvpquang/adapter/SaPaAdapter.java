...
public class SaPaAdapter extends BaseAdapter {
    int x = 0;
    private SaPaActivity context;
    private int layout;
    private List<Place> arraListPlace;

    public SaPaAdapter(SaPaActivity context, int layout, List<Place> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        SaPaAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new SaPaAdapter.ViewHolder();
            ...
            viewHolder = (SaPaAdapter.ViewHolder) view.getTag();
        }
