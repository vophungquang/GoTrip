...
public class DaNangAdapter extends BaseAdapter {
    int x = 0;
    private DaNangActivity context;
    private int layout;
    private List<Place> arraListPlace;

    public DaNangAdapter(DaNangActivity context, int layout, List<Place> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        DaNangAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new DaNangAdapter.ViewHolder();
            ...
            viewHolder = (DaNangAdapter.ViewHolder) view.getTag();
        }
