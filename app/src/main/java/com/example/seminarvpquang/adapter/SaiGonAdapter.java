...
public class SaiGonAdapter extends BaseAdapter {
    int x = 0;
    private SaiGonActivity context;
    private int layout;
    private List<Place> arraListPlace;

    public SaiGonAdapter(SaiGonActivity context, int layout, List<Place> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        SaiGonAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new SaiGonAdapter.ViewHolder();
