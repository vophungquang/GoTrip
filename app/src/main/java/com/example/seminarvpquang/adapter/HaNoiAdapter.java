...
public class HaNoiAdapter extends BaseAdapter {
    int x = 0;
    private HaNoiActivity context;
    private int layout;
    private List<Place> arraListPlace;

    public HaNoiAdapter(HaNoiActivity context, int layout, List<Place> subjectsList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        HaNoiAdapter.ViewHolder viewHolder = null;
        if (view == null){
            viewHolder = new HaNoiAdapter.ViewHolder();
            ...
            viewHolder = (HaNoiAdapter.ViewHolder) view.getTag();
        }
